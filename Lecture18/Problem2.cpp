...
int main()
{
    string name("Na4Cl4oct");      // for output files
    const int nNa = 4, nCl = 4;
    const int n = nNa + nCl;
    double a = 0.4;
    double r_Na[nNa][3] = { { 0, 0, 0 }, {1.707*a, 0.707*a, 0}, {a,2.414*a, 0}, {-0.707*a, 1.707*a, 0} };
    double r_Cl[nCl][3] = { { a, 0, 0 }, {1.707*a, 1.707*a, 0}, {0, 2.414*a, 0}, {-0.707*a, 0.707*a, 0} };
